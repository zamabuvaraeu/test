...
OBJECTFILES_DEBUG+=$(OBJ_DEBUG_DIR)$(PATH_SEP)gdi$(FILE_SUFFIX).o
OBJECTFILES_RELEASE+=$(OBJ_RELEASE_DIR)$(PATH_SEP)gdi$(FILE_SUFFIX).o

$(OBJ_DEBUG_DIR)$(PATH_SEP)gdi$(FILE_SUFFIX).c: 
$(OBJ_RELEASE_DIR)$(PATH_SEP)gdi$(FILE_SUFFIX).c: 
...
OBJECTFILES_DEBUG+=$(OBJ_DEBUG_DIR)$(PATH_SEP)Hash$(FILE_SUFFIX).o
OBJECTFILES_RELEASE+=$(OBJ_RELEASE_DIR)$(PATH_SEP)Hash$(FILE_SUFFIX).o

$(OBJ_DEBUG_DIR)$(PATH_SEP)Hash$(FILE_SUFFIX).c: src$(PATH_SEP)Hash.bi
$(OBJ_RELEASE_DIR)$(PATH_SEP)Hash$(FILE_SUFFIX).c: src$(PATH_SEP)Hash.bi

OBJECTFILES_DEBUG+=$(OBJ_DEBUG_DIR)$(PATH_SEP)Main$(FILE_SUFFIX).o
OBJECTFILES_RELEASE+=$(OBJ_RELEASE_DIR)$(PATH_SEP)Main$(FILE_SUFFIX).o

$(OBJ_DEBUG_DIR)$(PATH_SEP)Main$(FILE_SUFFIX).c: src$(PATH_SEP)Tree.bi src$(PATH_SEP)VerifyPassword.bi
$(OBJ_RELEASE_DIR)$(PATH_SEP)Main$(FILE_SUFFIX).c: src$(PATH_SEP)Tree.bi src$(PATH_SEP)VerifyPassword.bi
...
OBJECTFILES_DEBUG+=$(OBJ_DEBUG_DIR)$(PATH_SEP)Tree$(FILE_SUFFIX).o
OBJECTFILES_RELEASE+=$(OBJ_RELEASE_DIR)$(PATH_SEP)Tree$(FILE_SUFFIX).o

$(OBJ_DEBUG_DIR)$(PATH_SEP)Tree$(FILE_SUFFIX).c: src$(PATH_SEP)Tree.bi
$(OBJ_RELEASE_DIR)$(PATH_SEP)Tree$(FILE_SUFFIX).c: src$(PATH_SEP)Tree.bi

OBJECTFILES_DEBUG+=$(OBJ_DEBUG_DIR)$(PATH_SEP)Uuid$(FILE_SUFFIX).o
OBJECTFILES_RELEASE+=$(OBJ_RELEASE_DIR)$(PATH_SEP)Uuid$(FILE_SUFFIX).o

$(OBJ_DEBUG_DIR)$(PATH_SEP)Uuid$(FILE_SUFFIX).c: 
$(OBJ_RELEASE_DIR)$(PATH_SEP)Uuid$(FILE_SUFFIX).c: 

OBJECTFILES_DEBUG+=$(OBJ_DEBUG_DIR)$(PATH_SEP)VerifyPassword$(FILE_SUFFIX).o
OBJECTFILES_RELEASE+=$(OBJ_RELEASE_DIR)$(PATH_SEP)VerifyPassword$(FILE_SUFFIX).o

$(OBJ_DEBUG_DIR)$(PATH_SEP)VerifyPassword$(FILE_SUFFIX).c: src$(PATH_SEP)VerifyPassword.bi src$(PATH_SEP)Hash.bi
$(OBJ_RELEASE_DIR)$(PATH_SEP)VerifyPassword$(FILE_SUFFIX).c: src$(PATH_SEP)VerifyPassword.bi src$(PATH_SEP)Hash.bi
